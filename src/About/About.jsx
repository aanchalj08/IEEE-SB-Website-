			...
			<div className="flex flex-col lg:flex-row justify-between m-6">
				...
				<div className="flex flex-col flex-1 m-8">
					...
					<p className="text-[#5e5e5e] text-base">
						...
						and professional and educational activities. IEEE members get access
						to different technical societies, their publications at a discounted
						rate. IEEE is a leading developer of international standards that
						underpin many of today's telecommunications, IT and power generation
