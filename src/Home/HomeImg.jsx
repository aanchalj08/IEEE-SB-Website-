...
const HomeImg = () => {
  return (
    <div className="">
      ...
      <div className="relative bottom-[490px] left-[825px] text-white flex-col flex justify-center items-center w-[850px] md:max-xl:w-[450px] md:max-lg:left-[420px] max-sm:left-[225px] lg:max-xl:left-[560px] sm:max-md:w-[400px] sm:max-md:left-[350px] ">
